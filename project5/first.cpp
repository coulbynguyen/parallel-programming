...
//		NMB, LOCAL_SIZE, NUM_WORK_GROUPS, (double)NUM_ELEMENTS/(time1-time0)/1,000,000,000. );
    cout << NMB << "," << LOCAL_SIZE << "," << NUM_WORK_GROUPS << "," << (double)NUM_ELEMENTS/(time1-time0)/1000000000.0 << endl;
